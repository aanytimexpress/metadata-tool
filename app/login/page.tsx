...
import { Eye, EyeOff, LogIn, Sparkles, ArrowLeft, Mail, Lock, Loader2 } from "lucide-react"
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-card border border-border rounded-2xl shadow-2xl overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-primary to-primary/80 p-8 text-center">
            ...
            <p className="text-white/80 text-sm mt-1">Sign in to your MetadataGen account</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="p-8 space-y-5">
            ...
            <div className="grid grid-cols-2 gap-3">
              <button
                type="button"
                className="flex items-center justify-center gap-2 px-4 py-3 bg-secondary/50 border border-border rounded-xl text-foreground hover:bg-secondary transition-colors"
              >
